...
export default async function ServicePage({ params }) {
  ...
  return (
    <>
      {/* ================= HERO ================= */}
      <section className="relative h-[65vh] min-h-[520px] flex items-center justify-center text-center">
        <Image
          src={service.image}
          alt={service.title}
          fill
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-b from-[#0A192F]/60 to-[#0A192F]/80" />
      ...
      <section className="py-24 container mx-auto px-6 grid lg:grid-cols-2 gap-20 items-center">
        <div>
          ...
          <h2 className="text-4xl md:text-5xl font-black text-[#0A192F] mt-4 mb-8 tracking-tighter">
              ...
              return (
                ...
                >
                  <div className="w-14 h-14 rounded-full bg-[#26C6DA]/10 flex items-center justify-center mb-6">
                    <Icon className="text-[#26C6DA] text-2xl" />
                  </div>
      ...
      {service.faqs?.length > 0 && (
        <section className="py-24 container mx-auto px-6 max-w-4xl">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-black text-[#0A192F] tracking-tighter">
              {t("FAQ")}
            </h2>
          </div>
          ...
          <div className="space-y-4">
            {service.faqs.map((faq, i) => (
              <details
                key={i}
                className="border border-gray-100 p-6 rounded-lg group hover:shadow-md transition-all"
              >
                <summary className="cursor-pointer font-bold text-[#0A192F] flex justify-between items-center">
                  {t(`${slug}.faqs.${i}.q`)}
