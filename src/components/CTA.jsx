    ...
    <SectionWrapper className="relative overflow-hidden bg-[#0A192F] py-16">
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto py-4">
        ...
        <div className="mt-8 flex justify-center gap-4 flex-wrap">
          <Link
            href={primaryBtnLink}
            className="bg-[#26C6DA] text-[#0A192F] font-black uppercase tracking-widest py-4 px-8 text-xs rounded-sm hover:bg-white transition-all duration-300 shadow-[0_0_20px_rgba(38,198,218,0.3)] inline-flex items-center gap-2"
          >
            {displayPrimaryText}
          ...
          <Link
            ...
            className="border border-white/20 text-white font-black uppercase tracking-widest py-4 px-8 text-xs rounded-sm hover:border-[#26C6DA] hover:text-[#26C6DA] transition-all duration-300 inline-flex items-center gap-2"
          >
