  ...
  const socialLinks = [
    {
      ...
      href: "https://www.linkedin.com/company/azconinfra/",
    },
              ...
              <ul className="space-y-3 text-[11px] font-black uppercase tracking-widest">
                {Object.values(services).map((serviceName) => (
                  <li key={serviceName}>
                    <Link
                      href="/services"
                      className="text-gray-400 hover:text-[#26C6DA] transition-colors flex items-center gap-2 group"
                    >
            ...
            <div>
              ...
              <address className="not-italic text-gray-400 space-y-5 text-xs font-medium">
                <div className="flex items-start gap-4">
                  ...
                  <span className="uppercase tracking-tighter leading-relaxed">
                    {t("Address")}
                  </span>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex flex-col gap-1">
                    <a
                      ...
                      className="hover:text-white text-gray-200 transition-colors tracking-widest font-black"
                    >
                      {t("Contact.Phone")}
                    </a>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <a
                    ...
                    className="text-white hover:text-[#26C6DA] transition-colors tracking-widest font-black "
                  >
                    {t("Contact.Email")}
                  </a>
                </div>
